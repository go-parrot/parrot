...
const (
	...
	parrotAppPackage   = protogen.GoImportPath("github.com/go-parrot/parrot/pkg/app")
	errCodePackage     = protogen.GoImportPath("github.com/go-parrot/parrot/pkg/errcode")
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// is compatible with the parrot package it is being compiled against.")
	g.P()
	g.P("// ", contextPackage.Ident(""))
	g.P("// ", metadataPackage.Ident(""))
	g.P("// ", ginPackage.Ident(""), parrotAppPackage.Ident(""), errCodePackage.Ident(""))
	g.P()
